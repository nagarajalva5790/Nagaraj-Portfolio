  ...
  <section id="hero" className="min-h-screen flex items-center justify-center pt-24 px-6 relative overflow-hidden section-id-anchor">
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 pt-6">
        <a 
          href="#experience"
          className="px-8 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all transform hover:scale-105 shadow-[0_20px_40px_rgba(37,99,235,0.2)]"
        >
          View Experience
        </a>
        <a 
          href="./Nagaraj_Alva_Resume.pdf" 
          download="Nagaraj_Alva_Resume.pdf"
          className="px-8 py-5 border border-blue-600/30 dark:border-blue-400/30 hover:bg-blue-50 dark:hover:bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-sm flex items-center gap-2"
        >
        ...
        <a 
          href="#contact"
          className="px-8 py-5 border border-slate-300 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/5 bg-white dark:bg-transparent text-slate-900 dark:text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-sm"
        >
          Contact Me
        </a>
      </div>
